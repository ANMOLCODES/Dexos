...
function App() {
  ...
  return (
    <div className="bg-black min-w-2xl mx-auto relative min-h-screen pb-2">
      {error ? <Notification error={error} setError={setError} /> : ""}
      <nav className="bg-blue-900 shadow-sm flex items-center justify-between p-4 mb-20">
        <h1 className="text-white font-semibold">Dexos</h1>
      ...
      <div className=" m-20 p-4 bg-blue-900">
        <p className="text-xs text-white"> Dexos / Exchange</p>
        <form
      ...
      <div className=" m-20 p-4 bg-blue-900">
        <p className="text-xs text-white">Dexos / Add Liquidity</p>
      ...
      <div className="m-20 p-4 bg-blue-900">
        <p className="text-xs text-white">Dexos / Remove Liquidity</p>
